  ...
  useEffect(() => {
    ...
    setDailyReports([
      ...
      },
      {
        ...
        temperature: '68°F',
        description: 'Steel erection progressing. Inspector approved MEP rough-in.',
        crewSize: 42
      },
      {
        id: 3,
        ...
        weather: 'Light Rain',
        temperature: '65°F',
        description: 'Rain delayed exterior work by 2 hours. Interior work continued.',
        crewSize: 38
      }
    ]);
    ...
    <div>
          ...
          <div className="bg-blue-600 rounded-lg p-6 mb-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-blue-100">Full system control and management access</p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-6">
              ...
              <div className="text-3xl font-bold text-green-600 mb-2">
                {Math.round((teamMetrics.completedTasks / teamMetrics.tasksAssigned) * 100)}%
              </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <div className="text-3xl font-bold text-blue-600 mb-2">{dailyReports.length}</div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <div className="text-3xl font-bold text-blue-600 mb-2">{teamMetrics.totalUsers}</div>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-3 flex-1">
                      ...
                      <div className="flex-1">
                        <h4 className="font-medium text-gray-800 mb-1">{approval.description}</h4>
                    ...
                    <div className="flex items-center space-x-3">
                      <div className="text-right">
                        <div className="text-lg font-semibold text-orange-600">{approval.amount}</div>
                      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">2-Week Schedule Lookahead</h3>
              <div className="space-y-4">
                      ...
                      <div className="flex-1 bg-gray-200 rounded-full h-2">
                        <div
                          className={`h-2 rounded-full ${
                            task.statusColor === 'green' ? 'bg-green-500' : 'bg-orange-500'
                          }`}
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-800">Recent Photos</h3>
              ...
              {recentPhotos.length > 0 && recentPhotos[currentPhotoIndex] ? (
                <div className="relative">
                  ...
                  <div className="mt-3">
                    <h4 className="font-medium text-gray-800">{recentPhotos[currentPhotoIndex].title}</h4>
                    <p className="text-sm text-gray-500">
                      {recentPhotos[currentPhotoIndex].date} • {recentPhotos[currentPhotoIndex].location}
                    </p>
                  </div>
                </div>
              ) : (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Recent Daily Reports</h3>
              <div className="space-y-4">
                {dailyReports.map((report) => (
                  <div key={report.id} className="border-l-4 border-blue-500 pl-4">
                    ...
                    <div className="text-sm text-gray-500">({report.crewSize} crew)</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-800">Budget Variance by Trade</h3>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-500">{teamMetrics.admins} Admins, {teamMetrics.members} Members</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600 mb-2">{teamMetrics.activeSubcontractors}</div>
                <div className="text-gray-600 font-medium">Active Subcontractors</div>
                <div className="text-sm text-gray-500">{teamMetrics.onSiteSubcontractors} currently on-site</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-orange-600 mb-2">{teamMetrics.tasksAssigned}</div>
                <div className="text-gray-600 font-medium">Tasks Assigned</div>
                <div className="text-sm text-gray-500">{teamMetrics.completedTasks} completed</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-600 mb-2">{teamMetrics.documents}</div>
                <div className="text-gray-600 font-medium">Documents</div>
                <div className="text-sm text-gray-500">{teamMetrics.storageUsed} storage</div>
              </div>
            </div>
          </div>
    </div>
