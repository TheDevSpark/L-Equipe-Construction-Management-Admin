...
export default function DocumentsPage() {
  ...
  useEffect(() => {
    if (selectedProject) loadDocuments(selectedProject.id);
  }, [selectedProject]);
     ...
     const { error: dbError } = await supabase.from("documents").insert([
       {
         ...
         uploaded_by: user?.id, // ✅ this is UUID
...
const filteredDocs = documents.filter((doc) => {
  ...
  const matchSearch =
    ...
    uploadedBy.includes(searchTerm.toLowerCase());
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <label
            ...
            className="bg-primary text-primary-foreground px-4 py-2 rounded-lg cursor-pointer hover:bg-primary/90"
          >
